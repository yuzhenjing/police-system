...
$(function() {
    ...
    function menuItem() {
        ...
        $('.menuTab').each(function() {
            if ($(this).data('id') == dataUrl) {
                if (!$(this).hasClass('active')) {
                    ...
                    scrollToTab(this);
                    // 显示tab对应的内容区
                    $('.mainContent .police_iframe').each(function() {
                        if ($(this).data('id') == dataUrl) {
                            $(this).show().siblings('.police_iframe').hide();
                            return false;
                        }
                    });
                }
        ...
        if (flag) {
            ...
            // 添加选项卡对应的iframe
            var str1 = '<iframe class="police_iframe" name="iframe' + dataIndex + '" width="100%" height="100%" src="' + dataUrl + '" frameborder="0" data-id="' + dataUrl + '" seamless></iframe>';
            $('.mainContent').find('iframe.police_iframe').hide().parents('.mainContent').append(str1);
    ...
    function closeOtherTabs() {
        $('.page-tabs-content').children("[data-id]").not(":first").not(".active").each(function() {
            $('.police_iframe[data-id="' + $(this).data('id') + '"]').remove();
            $(this).remove();
        });
    ...
    function refreshTab() {
    	...
    	var target = $('.police_iframe[data-id="' + currentId + '"]');
    ...
    $('.tabCloseAll').on('click', function() {
        ...
        $('.page-tabs-content').children("[data-id]:first").each(function() {
            $('.police_iframe[data-id="' + $(this).data('id') + '"]').show();

...
import com.police.common.utils.file.FileUploadUtils;
...
import com.police.framework.web.service.DictService;
...
public class ProfileController extends BaseController
{
    ...
    public AjaxResult updateAvatar(@RequestParam("avatarfile") MultipartFile file)
    {
        ...
        try
        {
            if (!file.isEmpty())
            {
                String avatar = FileUploadUtils.upload(PoliceConfig.getAvatarPath(), file);
